        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contents_Admins_CreatedByAdminId",
                        column: x => x.CreatedByAdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contents_Admins_UpdatedByAdminId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contents_Images_CoverImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "text", nullable: false),
                    SectionImageId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sections_Images_SectionImageId",
                        column: x => x.SectionImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contents_CoverImageId",
                table: "Contents",
                column: "CoverImageId");

            migrationBuilder.CreateIndex(
                name: "IX_Contents_CreatedByAdminId",
                table: "Contents",
                column: "CreatedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Contents_UpdatedByAdminId",
                table: "Contents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sections_SectionImageId",
                table: "Sections",
                column: "SectionImageId");
        }
